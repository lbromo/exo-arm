...
kinkom=np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/kincom_logs/morten/april/MRF1_clean",
    delimiter=','
)
...
emg0_meas = np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/emg_logs/mr_morten/april/MRF1_emg0.log",
    delimiter=',')

emg1_meas = np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/emg_logs/mr_morten/april/MRF1_emg1.log",
    delimiter=',')

imu0_meas = np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/emg_logs/mr_morten/april/MRF1_imu0.log",
    delimiter=',')

imu1_meas = np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/emg_logs/mr_morten/april/MRF1_imu1.log",
    delimiter=',')
...
imu_start = np.where( tmp > 0.3 )[0][0] + 5
imu_stop = np.where( tmp > 0.3 )[0][1]
...
#angle_stop = -1 # We didnt lose any emg data
