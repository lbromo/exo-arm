...
kinkom=np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/kincom_logs/morten/april/MRF2_clean",
    delimiter=','
)
...
emg0_meas = np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/emg_logs/mr_morten/april/MRF2_emg0.log",
    delimiter=',')

emg1_meas = np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/emg_logs/mr_morten/april/MRF2_emg1.log",
    delimiter=',')

imu0_meas = np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/emg_logs/mr_morten/april/MRF2_imu0.log",
    delimiter=',')

imu1_meas = np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/emg_logs/mr_morten/april/MRF2_imu1.log",
    delimiter=',')
...
imu_start = np.where( tmp > 0.1 )[0][0] + 7
