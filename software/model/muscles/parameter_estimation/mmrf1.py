...
kinkom=np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/kincom_logs/morten/marts/MRF1_clean",
    delimiter=',')
...
emg1_meas = np.genfromtxt(
    "/afs/ies.auc.dk/group/17gr1035/Private/logs/emg_logs/mr_morten/marts/MRF1_emg0.log",
    delimiter=',')
