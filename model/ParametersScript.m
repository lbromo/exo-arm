...
%% Frictions 
cm= [0.0964    0.0072]*N;%[0.066 0.0359]*N;%;[0.0000    0.0143 ];%[0.0253    0.0143 ];%[0.0429    0.0108];%[0.0660 0.0359];%[165.0942/(N^2) 89.7613/(N^2)];%[31.519/(N^2) 18.6925/(N^2)];%[224.8743/(N^2) 95.9248/(N^2)];%[283.27/(N^2) 110.16/(N^2)];%[119.9795/(N^2) 51.5666/(N^2)];
